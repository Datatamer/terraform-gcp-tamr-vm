...
| tamr\_bigtable\_project\_id | The google project that the bigtable instance lives in | `string` | n/a | yes |
...
| tamr\_cloud\_sql\_project | project containing cloudsql instance | `string` | n/a | yes |
...
| tamr\_dataproc\_cluster\_service\_account | Service account to attach to dataproc workers. This only used if using the built in tamr\_dataproc\_cluster\_config configuration | `string` | `""` | no |
| tamr\_dataproc\_cluster\_subnetwork\_uri | Subnetwork URI for dataproc to use. This only used if using the built in tamr\_dataproc\_cluster\_config configuration | `string` | `""` | no |
...
| tamr\_dataproc\_cluster\_zone | Zone to launch dataproc cluster into. This only used if using the built in tamr\_dataproc\_cluster\_config configuration | `string` | `""` | no |
